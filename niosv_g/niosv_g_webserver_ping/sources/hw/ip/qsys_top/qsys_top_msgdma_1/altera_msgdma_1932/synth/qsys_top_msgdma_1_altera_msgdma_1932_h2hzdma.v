// qsys_top_msgdma_1_altera_msgdma_1932_h2hzdma.v
...
`timescale 1 ps / 1 ps
module qsys_top_msgdma_1_altera_msgdma_1932_h2hzdma (
	...
	write_master #(
		...
		.STRIDE_WIDTH                   (1),
		.ACTUAL_BYTES_TRANSFERRED_WIDTH (20)
	) write_mstr_internal (
		.clk                       (clock_clk),                                      //   input,    width = 1,             Clock.clk
		.reset                     (~reset_n_reset_n),                               //   input,    width = 1,       Clock_reset.reset
		...
		.snk_data                  (st_sink_data),                                   //   input,   width = 32,         Data_Sink.data
		...
		.snk_empty                 (st_sink_empty),                                  //   input,    width = 2,                  .empty
		.snk_error                 (st_sink_error),                                  //   input,    width = 6,                  .error
