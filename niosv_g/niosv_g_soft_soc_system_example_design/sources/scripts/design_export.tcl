...
# project_new top
# 
# Info: Current script was exported with Quartus Prime Pro Release 26.1.1 Build 60
# 
regexp {[\.0-9]+} $quartus(version) import_release
if {$import_release != "26.1.1"} {
	post_message -type error "Cannot import script exported from Quartus Prime Pro version \"26.1.1 Build 60\" into current release \"$import_release\".\n\tOpen, upgrade, and validate the original system in VDS to ensure design correctness."
	return
}
...
vds::create_cell -properties { parameters:CTRL_ECC_AUTOCORRECT_EN {false} parameters:EX_DESIGN_USER_PLL_OUTPUT_FREQ_MHZ {110.0} parameters:MEM_CA_VREF {13} parameters:MEM_CHANNEL_DATA_DQ_WIDTH {32} parameters:MEM_CL_CYC {14} parameters:MEM_CWL_CYC {12} parameters:MEM_DQ_VREF {20} parameters:MEM_MINNUMREFSREQ {8192.0} parameters:MEM_NUM_CHANNELS {1} parameters:MEM_ODT_CA_X_CA_COMM {3} parameters:MEM_ODT_CA_X_CA_ENABLE {true} parameters:MEM_ODT_CA_X_CK_ENABLE {true} parameters:MEM_ODT_CA_X_CS_ENABLE {true} parameters:MEM_ODT_DQ_X_IDLE {off} parameters:MEM_ODT_DQ_X_RON {6} parameters:MEM_ODT_DQ_X_TGT_WR {5} parameters:MEM_OPERATING_FREQ_MHZ {800} parameters:MEM_PER_BANK_REF_EN {1} parameters:MEM_TCCD_NS {10.0} parameters:MEM_TCKCKEH_NS {3.75} parameters:MEM_TCKCKEL_NS {6.25} parameters:MEM_TCKEHCMD_NS {7.5} parameters:MEM_TCKELCK_NS {6.25} parameters:MEM_TCKELCMD_NS {6.25} parameters:MEM_TCKE_NS {7.5} parameters:MEM_TCMDCKE_NS {3.75} parameters:MEM_TCSCKEH_NS {1.75} parameters:MEM_TCSCKE_NS {1.75} parameters:MEM_TDQSCK_MAX_NS {3.5} parameters:MEM_TDQSCK_MIN_NS {1.5} parameters:MEM_TESCKE_NS {3.75} parameters:MEM_TFAW_NS {40.0} parameters:MEM_TMRD_NS {14.0} parameters:MEM_TMRR_NS {10.0} parameters:MEM_TMRWCKEL_NS {14.0} parameters:MEM_TMRW_NS {12.5} parameters:MEM_TPPD_CYC {4.0} parameters:MEM_TRAS_NS {42.0} parameters:MEM_TRCD_NS {18.0} parameters:MEM_TRC_NS {63.0} parameters:MEM_TREFI_NS {3904.0} parameters:MEM_TREFW_NS {3.2E7} parameters:MEM_TRFCAB_NS {380.0} parameters:MEM_TRFCPB_NS {190.0} parameters:MEM_TRPAB_NS {21.0} parameters:MEM_TRPPB_NS {18.0} parameters:MEM_TRRD_NS {10.0} parameters:MEM_TRTP_NS {10.0} parameters:MEM_TSR_NS {15.0} parameters:MEM_TWR_NS {18.0} parameters:MEM_TWTR_NS {10.0} parameters:MEM_TXP_NS {7.5} parameters:MEM_TXSR_NS {387.5} parameters:MEM_TZQCAL_NS {1000.0} parameters:MEM_TZQCKE_NS {3.75} parameters:MEM_TZQLAT_NS {30.0} parameters:MEM_VREF_CA_X_CA_VALUE {27.2} parameters:MEM_VREF_DQ_X_VALUE {18.0} parameters:MEM_WLS {1.0} parameters:PHY_AC_TX_EQUALIZATION {OFF} parameters:PHY_CK_TX_EQUALIZATION {OFF} parameters:PHY_CS_TX_EQUALIZATION {OFF} parameters:PHY_DQ_TX_EQUALIZATION {OFF} parameters:PHY_MAINBAND_ACCESS_MODE {ASYNC} parameters:PHY_REFCLK_FREQ_MHZ {200.0} parameters:PHY_SIDEBAND_ACCESS_MODE {FABRIC} parameters:PHY_SWIZZLE_MAP {BYTE_SWIZZLE_CH0=3,2,X,X,X,X,1,0; PIN_SWIZZLE_CH0_DQS0=3,2,1,0,5,4,7,6; PIN_SWIZZLE_CH0_DQS1=15,13,14,12,9,8,10,11; PIN_SWIZZLE_CH0_DQS2=16,18,17,19,23,20,22,21; PIN_SWIZZLE_CH0_DQS3=31,30,28,29,25,24,26,27;} parameters:PHY_TERM_X_AC_OUTPUT_IO_STD_TYPE {LVSTL} parameters:PHY_TERM_X_AC_SLEW_RATE {FASTEST} parameters:PHY_TERM_X_CK_OUTPUT_IO_STD_TYPE {DF_LVSTL} parameters:PHY_TERM_X_CK_SLEW_RATE {FASTEST} parameters:PHY_TERM_X_CS_OUTPUT_IO_STD_TYPE {LVSTL} parameters:PHY_TERM_X_CS_SLEW_RATE {FASTEST} parameters:PHY_TERM_X_DQS_IO_STD_TYPE {DF_LVSTL} parameters:PHY_TERM_X_DQ_IO_STD_TYPE {LVSTL} parameters:PHY_TERM_X_DQ_SLEW_RATE {FASTEST} parameters:PHY_TERM_X_DQ_VREF {17.5} parameters:PHY_TERM_X_GPIO_IO_STD_TYPE {LVCMOS} parameters:PHY_TERM_X_REFCLK_IO_STD_TYPE {TRUE_DIFF} parameters:PHY_TERM_X_R_S_AC_OUTPUT_OHM {SERIES_40_OHM_CAL} parameters:PHY_TERM_X_R_S_CK_OUTPUT_OHM {SERIES_40_OHM_CAL} parameters:PHY_TERM_X_R_S_CS_OUTPUT_OHM {SERIES_40_OHM_CAL} parameters:PHY_TERM_X_R_S_DQ_OUTPUT_OHM {SERIES_40_OHM_CAL} parameters:PHY_TERM_X_R_T_DQ_INPUT_OHM {RT_50_OHM_CAL} parameters:PHY_TERM_X_R_T_GPIO_INPUT_OHM {RT_OFF} parameters:PHY_TERM_X_R_T_REFCLK_INPUT_OHM {RT_DIFF}  } -vlnv altera.com:ip:emif_io96b_lpddr4: emif_io96b_lpddr4_0
...
vds::create_cell -properties { parameters:peripheralRegionABase {589824} parameters:peripheralRegionASize {65536} parameters:resetSlave {ocm_boot_niosv.axi_s1}  } -vlnv altera.com:ip:intel_niosv_g: intel_niosv_g_0
...
vds::create_cell -properties { parameters:idWidth {3} parameters:initMemContent {false} parameters:interfaceType {1} parameters:memorySize {524288}  } -vlnv altera.com:ip:intel_onchip_memory: ocm_boot_niosv
vds::create_cell -properties { parameters:initMemContent {false} parameters:memorySize {1048576}  } -vlnv altera.com:ip:intel_onchip_memory: ocm_read_dma_write
vds::create_cell -properties { parameters:initMemContent {false} parameters:memorySize {1048576}  } -vlnv altera.com:ip:intel_onchip_memory: ocm_write_dma_read
vds::create_cell -properties { parameters:width {4}  } -vlnv altera.com:ip:altera_avalon_pio: pio_0
vds::create_cell -properties { parameters:direction {Input} parameters:width {4}  } -vlnv altera.com:ip:altera_avalon_pio: pio_1
vds::create_cell -vlnv altera.com:ip:altera_reset_bridge: reset_bridge_0
...
vds::create_cell -properties { parameters:period {1000} parameters:resetOutput {true} parameters:timeoutPulseOutput {true}  } -vlnv altera.com:ip:altera_avalon_timer: timer_0
...
vds::set_domain_properties {qsys_mm.burstAdapterImplementation GENERIC_CONVERTER qsys_mm.clockCrossingAdapter HANDSHAKE qsys_mm.enableAllPipelines FALSE qsys_mm.enableEccProtection FALSE qsys_mm.enableInstrumentation FALSE qsys_mm.enableOutOfOrderSupport FALSE qsys_mm.fifoDepth 8 qsys_mm.insertDefaultSlave FALSE qsys_mm.interconnectResetSource DEFAULT qsys_mm.maxAdditionalLatency 1 qsys_mm.optimizeRdFifoSize FALSE qsys_mm.piplineType PIPELINE_STAGE qsys_mm.responseFifoType REGISTER_BASED qsys_mm.splitCommandsFor4KBoundary FALSE qsys_mm.syncResets TRUE qsys_mm.widthAdapterImplementation GENERIC_CONVERTER } address_span_extender_0.expanded_master
vds::set_domain_properties {qsys_mm.burstAdapterImplementation GENERIC_CONVERTER qsys_mm.clockCrossingAdapter HANDSHAKE qsys_mm.enableAllPipelines FALSE qsys_mm.enableEccProtection FALSE qsys_mm.enableInstrumentation FALSE qsys_mm.enableOutOfOrderSupport FALSE qsys_mm.fifoDepth 8 qsys_mm.insertDefaultSlave FALSE qsys_mm.interconnectResetSource DEFAULT qsys_mm.maxAdditionalLatency 1 qsys_mm.optimizeRdFifoSize FALSE qsys_mm.piplineType PIPELINE_STAGE qsys_mm.responseFifoType REGISTER_BASED qsys_mm.splitCommandsFor4KBoundary FALSE qsys_mm.syncResets TRUE qsys_mm.widthAdapterImplementation GENERIC_CONVERTER } emif_axi_adaptor_eagle_0.emif_axi
vds::set_domain_properties {qsys_mm.burstAdapterImplementation GENERIC_CONVERTER qsys_mm.clockCrossingAdapter HANDSHAKE qsys_mm.enableAllPipelines FALSE qsys_mm.enableEccProtection FALSE qsys_mm.enableInstrumentation FALSE qsys_mm.enableOutOfOrderSupport FALSE qsys_mm.fifoDepth 8 qsys_mm.insertDefaultSlave FALSE qsys_mm.interconnectResetSource DEFAULT qsys_mm.maxAdditionalLatency 1 qsys_mm.optimizeRdFifoSize FALSE qsys_mm.piplineType PIPELINE_STAGE qsys_mm.responseFifoType REGISTER_BASED qsys_mm.splitCommandsFor4KBoundary FALSE qsys_mm.syncResets TRUE qsys_mm.widthAdapterImplementation GENERIC_CONVERTER } emif_ph2_axil_driver_0.axil_driver_axi4_lite
