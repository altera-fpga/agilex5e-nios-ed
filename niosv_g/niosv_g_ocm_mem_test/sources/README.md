# Nios® V/g Processor-based OCM test example design

 Agilex 5 FPGA - OCM Memory test example design on Nios® V/g Processor

## Description

Nios® V/g Processor-based OCM test example design on the Agilex® 5 FPGA E-Series 065B Premium Development Kit (ES1) DKA5E065BB32AES1

![image](https://github.com/altera-fpga/agilex5e-nios-ed/blob/rel/25.1.1/niosv_g/niosv_g_ocm_mem_test/img/hello_world_ocm.png)
...
- **Design Package**: agilex5_niosv_g_ocm_mem_test.zip
- **Category**: Memory
- **URL**: https://github.com/altera-fpga/agilex5e-nios-ed/blob/rel/25.1.1/niosv_g/niosv_g_ocm_mem_test/
- **download URL**: https://github.com/altera-fpga/agilex5e-nios-ed/releases/download/25.1.1-v1.0/agilex5_niosv_g_ocm_mem_test.zip
...
#### Binaries
 - Prebuilt binaries are located [here](https://github.com/altera-fpga/agilex5e-nios-ed/blob/rel/25.1.1/niosv_g/niosv_g_ocm_mem_test/ready_to_test).
...
#### Nios V Address Map
 |Address Offset	|Size (Bytes)	|Peripheral	| Description|
  |-|-|-|-|
  |0x0000_0000|512KB|On-Chip RAM|To store application|
  |0x0000_0040|8|JTAG UART|Communication between a host PC and the Nios V processor system|
  |0x0009_0048|8|System ID|Hardware configuration system ID (165)|
  ||||
