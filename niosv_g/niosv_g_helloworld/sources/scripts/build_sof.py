...
# Generate elf for hal application
app_creation = subprocess.Popen(["niosv-shell < scripts/niosv_app_creation_hal.sh"], stdout=subprocess.PIPE, stderr=subprocess.STDOUT,shell= True)
for line in app_creation.stdout:
    logfile.write(line)
app_creation.wait()

# Generate elf for freertos application
app_creation = subprocess.Popen(["niosv-shell < scripts/niosv_app_creation_freertos.sh"], stdout=subprocess.PIPE, stderr=subprocess.STDOUT,shell= True)
for line in app_creation.stdout:
    logfile.write(line)
app_creation.wait()
