...
int main()
{
        ...
        printf ("Hello World from Agilex-5  NIOSV/m core! \n");
        ...
        for (i =0 ; i < 32 ; i=i+4)
        {
                ...
                // Write a test pattern (0xA5A5A5A5) to the specified memory location
                IOWR_32DIRECT(OCM_BASE,i,0xa5a5a5a5);
                
                // Read back value from memory to verify write operation
        ...
        // Indicate memory test completion
        printf("Memory Test Complete \n");

	// Read system ID from peripheral core
