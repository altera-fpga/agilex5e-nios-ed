	qsys_top_intel_eth_tse_0 u0 (
		...
		.magic_wakeup  (_connected_to_magic_wakeup_),  //  output,   width = 1,           mac_misc_connection.magic_wakeup
		...
		.rgmii_in      (_connected_to_rgmii_in_),      //   input,   width = 4,          mac_rgmii_connection.rgmii_in
		.rgmii_out     (_connected_to_rgmii_out_),     //  output,   width = 4,                              .rgmii_out
		.rx_control    (_connected_to_rx_control_),    //   input,   width = 1,                              .rx_control
		.tx_control    (_connected_to_tx_control_),    //  output,   width = 1,                              .tx_control
		.rgmii_tx_clk  (_connected_to_rgmii_tx_clk_),  //  output,   width = 1,                              .rgmii_tx_clk
		.rgmii_rx_clk  (_connected_to_rgmii_rx_clk_),  //   input,   width = 1,                              .rgmii_rx_clk
