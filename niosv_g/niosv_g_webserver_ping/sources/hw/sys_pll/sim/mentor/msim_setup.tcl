...
# ----------------------------------------
# ACDS 25.3 109 linux 2025.10.22.04:04:41
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sys_pll.sys_pll"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/p/psg/swip/releases6/acdskit/25.3/109/linux64/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [sys_pll::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [sys_pll::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [sys_pll::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [sys_pll::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [sys_pll::normalize_path "$file"]
  set normalized_dest [sys_pll::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [sys_pll::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [sys_pll::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [sys_pll::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [sys_pll::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
