...
# ----------------------------------------
# ACDS 25.3 109 linux 2025.10.22.04:04:40
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [issp::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [issp::normalize_path "$file"]
  set normalized_dest [issp::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [issp::get_dpi_libraries "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set common_design_files [dict values [issp::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [issp::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
