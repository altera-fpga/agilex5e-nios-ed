...
module intel_tse_rgmii_module /* synthesis ALTERA_ATTRIBUTE = "SUPPRESS_DA_RULE_INTERNAL=\"D103\"" */ (   // new ports to cater for mii with RGMII interface are added 
                      // inputs
                       rgmii_in,
					   speed,
		       rgmii_delay_reg,
  ...
  wire    speed_reg;
  wire    rgmii_delay_reg_rgmii_rx_clk;
  ...
  altera_tse_rgmii_in4 the_rgmii_in4
    (
      ...
      .inclock (rgmii_rx_clk)             //OUTPUT
    );
    defparam
    the_rgmii_in4.DEVICE_FAMILY = DEVICE_FAMILY;
  ...
  altera_tse_rgmii_in1 the_rgmii_in1
    ...
    defparam
    the_rgmii_in1.DEVICE_FAMILY = DEVICE_FAMILY;


always @(posedge rgmii_rx_clk or posedge reset_rx_clk)
    begin
...
altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_RGMII_REG_SYNC(
			.clk(rgmii_rx_clk), // INPUT
			.reset_n(~reset_rx_clk), //INPUT
			.din(rgmii_delay_reg), //INPUT
			.dout(rgmii_delay_reg_rgmii_rx_clk));// OUTPUT
...
always @(posedge rgmii_rx_clk or posedge reset_rx_clk)
    begin
        ...
        else if (rgmii_delay_reg_rgmii_rx_clk == 1'b1) begin
            rgmii_in_4_reg <= {rgmii_in_4_wire[3:0], rgmii_in_4_temp_reg[7:4]};
            rx_err <= rgmii_in_1_wire[0];
            rx_dv <= rgmii_in_1_temp_reg[1];            
        end
        else begin
            rgmii_in_4_reg <= {rgmii_in_4_wire[7:4], rgmii_in_4_wire[3:0]};
            rx_err <= rgmii_in_1_wire[1];
            rx_dv <= rgmii_in_1_wire[0];            
        end
    end
...
altera_eth_tse_std_synchronizer #(SYNCHRONIZER_DEPTH) U_SYNC_2(
  ...
  altera_tse_rgmii_out4 the_rgmii_out4
    (
      ...
      .datain_h (rgmii_out_4_wire[7 : 4]),   //INPUT
      .datain_l (rgmii_out_4_wire[3 : 0]),   //INPUT
      .dataout (rgmii_out),         //INPUT
      .outclock (tx_clk)            //OUTPUT
    );
    defparam
    the_rgmii_out4.DEVICE_FAMILY = DEVICE_FAMILY;
  ...
  altera_tse_rgmii_out1 the_rgmii_out1
    (
      .aclr (reset_tx_clk),         //INPUT
      .datain_h (rgmii_out_1_wire_inp2),         //INPUT
      .datain_l (rgmii_out_1_wire_inp1),           //INPUT     
      .dataout (tx_control),        //INPUT
      .outclock (tx_clk)            //OUTPUT
    );
    defparam
    the_rgmii_out1.DEVICE_FAMILY = DEVICE_FAMILY;
...
`pragma questa_oem_00 ""
`endif